...
export default function Projects() {
  return (
    <>
      <NextSeo
        title="Projects by Aakash Tripathi - Software Developer Portfolio"
        description="Explore a collection of projects by Aakash Tripathi, a seasoned Software Developer. From innovative web applications to responsive interfaces, discover the depth and diversity of my work."
        canonical={`${siteMetadata.siteUrl}/projects`}
        openGraph={{
          url: `${siteMetadata.siteUrl}/projects`,
          title: "Discover Projects by Aakash Tripathi - Software Developer",
          description:
